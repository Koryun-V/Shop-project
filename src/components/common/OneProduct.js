                                            ...
                                            className="product__store_name">Quantity - {oneProductInfo?.result?.product?.quantity} </span>
                                                ...
                                                <div className="product__quantity">
                                                    <div className="product__button__cart">
                                                        <Button
                                                            text={oneProductInfo.result.product.status ? "The item is unavailable" : "Add to cart"}

                                                            disabled={quantityNumber === 0 || oneProductInfo.result.product.status }
                                                    ...
                                                    <input className="product__value" type="text" onBlur={quantityBlur}
                                                           ...
                                                           onChange={onChange}/>
                                                    <button
                                                        disabled={quantity >= quantityNumber || oneProductInfo.result.product.status}
