            ...
            <div className="section">
                <div className="select_container">
                    ...
                    <form action="#" className="price-container">
                        ...
                        <div>
                            <input type="text" className="price-input" value={minPrice}
                                   onChange={(e) => handleSliderChange([+e.target.value, maxPrice])}/>
                            <input type="text" className="price-input" value={maxPrice}
                                   onChange={(e) => handleSliderChange([minPrice, +e.target.value])}/>
                        </div>
                        <Slider className="price-slider" onChange={handleSliderChange} value={[minPrice, maxPrice]}
                                min={0} max={2000}/>
                    </form>
