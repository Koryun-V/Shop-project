...
import { getUserProfileRequest, updateUserProfileRequest, setProfile, updatePassword, setPasswordData, setAvatar } from '../actions/users';
...
export const userSlice = createReducer(initialState, (builder) => {
  builder
    ...
    .addCase(setProfile, (state, { payload }) => {
      ...
      state.validationErrors = {}
      state.profile = { ...state.profile, ...payload, dateOfBirth: dateOfBirth === 'Invalid date'
